...
if __name__ == "__main__":
    ...
    root_dir = pathlib.Path(r"\\et-nas.humlab.lu.se\Gábor\pupil_size_validation\pilot7_251022")
    base_path = pathlib.Path(r"\\et-nas.humlab.lu.se\Gábor\pupil_size_validation\pilot7_251022\sam2\segmentation")
