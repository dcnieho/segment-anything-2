...
def retrieve_prompt_from_subject(video_path, gt_dir, frame_idx_override):
    ...
    gt_file = gt_dir / f'NVIDIAAR_{video_path.stem.lstrip("0")}_1.mp4pupil_eli.txt'
...
if __name__ == '__main__':
    ...
    output_bin = pathlib.Path(f"//et-nas.humlab.lu.se/FLEX/datasets real/nvgaze_real_dataset_ar/sam2/{from_sample}/") # will contain saved masks
    ...
    subject_folders = [f for f in root_dir.iterdir() if f.suffix=='.zip']
