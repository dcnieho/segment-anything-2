...
if __name__ == '__main__':
    ...
    prompt_frame_hardcode = {}

    # Output path for results and backup
    output_bin = pathlib.Path(f"//et-nas.humlab.lu.se/FLEX/datasets real/nvgaze_real_dataset_vr/sam2/{from_sample}/") # will contain saved masks
